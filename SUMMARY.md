...
* [Whitepaper](whitepaper/abstract.md)
    ...
    * [Design Goals](whitepaper/design-goals.md)
    * [Smart‑Contract Specification](whitepaper/smart-contract-specification.md)
    * [Swap Flow](whitepaper/swap-flow.md)
    * [Security Analysis](whitepaper/security-analysis.md)
    * [Parameter Selection](whitepaper/parameter-selection.md)
    * [Edge‑Case Handling](whitepaper/edge-case-handling.md)
